...
import time
import xlsxwriter
from citycode import CitiesCode
...
def city_migration(file_title, direction, code):
	if direction == 'in':
		...
		migration = '迁出目的地'
	workbook = xlsxwriter.Workbook(f'广西全国地市迁徙数据\\{file_title}-{migration}规模指数.xlsx')
...
if __name__ == '__main__':
	dict1 = {
		'南宁市': 450100,
		'柳州市': 450200, '桂林市': 450300, '梧州市': 450400, '北海市': 450500, '防城港市': 450600, '钦州市': 450700,
